                        ...
                        <table id="leave_typesTable" class="table datatable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" class="btn "style="background-color: #ffb84d" data-bs-toggle="modal" data-bs-target="#updateModal" onclick="setUpdateData(<?php echo htmlspecialchars(json_encode($leave_type)); ?>)">Update</button>
                                        <button type="button" class="btn "style="background-color: #ff5050" data-bs-toggle="modal" data-bs-target="#deleteModal" onclick="setDeleteData(<?php echo $leave_type['id']; ?>)">Delete</button>
                                    </td>
                                </tr>
                                <?php endforeach; ?>
                            </tbody>
