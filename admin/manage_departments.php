                        ...
                        <table id="departmentsTable" class="table datatable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" class="btn"style="background-color: #ffb84d" data-bs-toggle="modal" data-bs-target="#updateModal" onclick="setUpdateData(<?php echo $department['id']; ?>, '<?php echo $department['name']; ?>')">Update</button>
                                        <button type="button" class="btn "style="background-color: #ff5050" data-bs-toggle="modal" data-bs-target="#deleteModal" onclick="setDeleteData(<?php echo $department['id']; ?>)">Delete</button>
                                    </td>
                                </tr>
                                <?php endforeach; ?>
                            </tbody>
